  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
      ...
      <div className="space-y-4">
        ...
        {/* Alert Status */}
        <div>
          <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Alert Status</h4>
        ...
        {/* Assigned To */}
        <div>
          <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Assigned To</h4>
